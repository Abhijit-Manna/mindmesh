...
def convert_mermaid_blocks(html: str) -> str:
    """
    Convert Mermaid fenced-code blocks generated by Markdown
    into Mermaid containers that can be rendered by Mermaid.js.
    """
    ...
    def replace_mermaid(match):
        ...
        # Decode HTML entities that Markdown may have escaped
        mermaid_code = (
            mermaid_code
            .replace("&gt;", ">")
            .replace("&lt;", "<")
